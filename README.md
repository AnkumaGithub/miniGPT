# miniGPT
Здесь написана gpt модель на 150 млн параметров и дообучена gpt2 на том же датасете    
...
Документация - https://docs.google.com/document/d/1VgG5o1frLVFU7ypY1wmLkiCGKF2764si/edit?usp=drive_link&ouid=114236114426512766984&rtpof=true&sd=true
